...
const processSteps = [
  ...
  },
  {
    ...
    body: 'Your Fixed Monthly Yield lands on day 1 of each calendar month. Your monthly income is consistent and all day-to-day management will be handled by us.',
    timeline: 'Ongoing',
    icon: DollarSign,
    highlight: true,
  },
